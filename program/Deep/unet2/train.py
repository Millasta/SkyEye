#encoding:utf-8
from program.Deep.unet2.model_v2 import  *
...
if __name__ == '__main__':
    ...
    model_checkpoint = keras.callbacks.ModelCheckpoint('./model/model.hdf5', monitor='val_loss',verbose=1,save_best_only=True)
